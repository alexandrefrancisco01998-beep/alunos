...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Migração 3 → 4: adiciona o código único da disciplina
         * ao cache local para permitir sincronização em tempo real.
         */
        private val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    "ALTER TABLE `disciplinas_cache` ADD COLUMN `codigo_unico_disciplina` TEXT NOT NULL DEFAULT ''"
                )
            }
        }
